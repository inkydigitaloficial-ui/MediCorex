...
export default async function TenantLayout({ children, params }: Props) {
  ...
  const tenantIsValid = await isValidTenant(tenantId);
        ...
        <Sidebar>
          <SidebarHeader>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-semibold font-headline">TenantFlow</h1>
            </div>
          </SidebarHeader>
          <SidebarContent>
            <SidebarMenu>
          ...
          <SidebarFooter>
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 overflow-hidden">
                <p className="text-sm font-medium truncate">{tenantId} User</p>
