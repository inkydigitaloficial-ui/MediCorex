    ...
    <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
       <div className="flex items-center">
        <h1 className="text-lg font-semibold md:text-2xl font-headline">
            Análise de Insights para Paciente: {params.pacienteId}
        </h1>
       </div>
        ...
        <div className="md:col-span-1">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Descreva o que você deseja analisar sobre este paciente.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                        <form action={formAction} className="space-y-6">
                            <input type="hidden" name="tenantId" value={params.tenantId} />
                            <input type="hidden" name="customerId" value={params.pacienteId} />
                            <FormField
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                    <Textarea
                                        placeholder="Ex: 'Analisar o histórico de consultas e sugerir próximos passos.'"
